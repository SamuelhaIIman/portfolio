function initializeTailwind() {
            document.documentElement.style.setProperty('--accent', '#00a63e');
        }
        ...
        const projectsData = [
            ...
            },
            {
                ...
                github: "#",
                demo: "https://www.arkhaltia.fi/",
                type: "Professional Work @ ARKHALTIA Oy"
            },
            {
                id: 6,
                title: "Lauran Jalkahoitola Wix Performance & SEO Overhaul",
                shortDesc: "Transformed a slow architecture firm website into a fast, SEO-optimized platform. Achieved massive improvements in load time and organic visibility.",
                longDesc: "Performed deep performance audit and optimization on a Wix site: aggressive image compression and Web Vitals improvements.",
                category: "web",
                tech: ["Wix", "Canva", "SEO", "PageSpeed Insights"],
                icon: "fa-globe",
                image: "images/lauran_jalkahoito.png",
                impact: "Custom website created for a client with their requirements.",
                github: "#",
                ...
                card.innerHTML = `
                    <div class="relative h-48 overflow-hidden">
                        ...
                        <div class="absolute top-4 left-4">
                            <div class="text-[10px] px-3 py-1 rounded-full bg-black/50 backdrop-blur text-white font-medium tracking-wider">${project.type.split(' @ ')[0]}</div>
                        </div>
                        <div class="absolute bottom-4 left-4 w-11 h-11 rounded-2xl bg-zinc-900/80 backdrop-blur border border-white/10 flex items-center justify-center text-green-600">
                            <i class="fas ${project.icon} text-xl"></i>
                        </div>
                    </div>
                    
                    <div class="p-6 flex-1 flex flex-col">
                        <h3 class="font-semibold text-xl tracking-tight leading-tight mb-2 pr-2">${project.title}</h3>
                        
                        <p class="text-sm text-zinc-400 line-clamp-2 flex-1">${project.shortDesc}</p>
                        
                        <div class="flex flex-wrap gap-1.5 mt-4 mb-3">
